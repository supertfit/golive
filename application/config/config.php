...
define('HTTP_MARKER_PATH', $config['base_url'].'assets/markers/');
...
define('HTTP_EXPORT_BASE', $config['base_url'].'assets/exports/');
...
define('GENIUS_ICON_PATH', $config['base_url'].'assets/genius/ico/');
define('GENIUS_IMAGES_PATH', $config['base_url'].'assets/genius/img/');
define('GENIUS_MISC_PATH', $config['base_url'].'assets/genius/misc/');
...
|
*/
$config['log_path'] = './goLive_backend.log';
