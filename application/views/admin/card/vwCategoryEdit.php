					...
					<div class="col-lg-12">
						<div class="box">
							<div class="box-header">
								<h2><i class="icon-tag"></i><span class="break"></span>Category Card Edit</h2>
							</div>
							<div class="box-content">
							    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/categoryCard/save">
    								<fieldset>
        								...
        								<div class="form-group">
        								    ...
        								    <div class="col-md-5">
        								        <p class="form-control"><?php echo $data->category_name;?></p>
        								    </div>
        								</div>       								    							    
        								...
        								<div class="form-group">
        								    ...
        								    <div class="col-md-5">
        								        <img src="<?php echo HTTP_MARKER_PATH.$data->category_cover_photo_url;?>" style="width: 100%;"/>
        								    </div>
        								</div>
        								<div class="form-group">
        								    <label class="col-md-4 control-label"></label>  
        								    <div class="col-md-5">
        								        <p class="form-control-static">
        								            Download : 
        								            <a href="<?php echo HTTP_MARKER_PATH.$data->category_cover_photo_url;?>">
        								                <?php echo $data->category_cover_photo_url;?>
        								            </a>
        								        </p>
        								    </div>
        								</div>
        								...
        								<div class="form-group">
        								    <label class="col-md-4 control-label">Prefilm</label>  
        								    <div class="col-md-5">
        								        <p class="form-control-static">
        								            Download :
        								            <a href="<?php echo HTTP_VIDEO_PATH.$data->category_prefilm_url;?>">
        								                <?php echo $data->category_prefilm_url;?>
        								            </a>
        								        </p>
        								    </div>
        								</div>        								        								
        								...
        								<div class="form-group">
        								    ...
        								    <div class="col-md-5">
        								        ...
        								        <button class="btn btn-success">
        								            <a href="<?php echo base_url();?>admin/categoryCard">Back</a>
        								        </button>
        								        &nbsp;&nbsp;&nbsp;
        								        <button class="btn btn-danger">
        								            <a class="js-link" href="<?php echo base_url();?>admin/categoryCard/delete/<?php echo $data->id;?>">Delete</a>
        								        </button>     
        								    </div>
        								</div>      								
    								</fieldset>			
