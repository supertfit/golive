			...
			<div class="col-lg-12">
				<div class="box">
					<div class="box-header">
						<h2><i class="icon-tag"></i><span class="break"></span>List</h2>
						<div class="pull-right areaBtnAdd">
							<a class="btn btn-primary" href='<?php echo base_url();?>admin/categoryCard/csv'>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="tblCustomCardList">
						  ...
						  ?>
							  	<tr>
							  		...
							  		<td>
										<a class="btn btn-info btn-sm" href='<?php echo base_url();?>admin/categoryCard/edit/<?php echo $v->id;?>'>
