					...
					<div class="col-lg-12">
						<div class="box">
							<div class="box-header">
								<h2><i class="icon-flat"></i><span class="break"></span>Edit Delivery Note</h2>
							</div>
							<div class="box-content">
							    <form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/deliveryNote/save">
    								<fieldset>
    								    <input type="hidden" name="delivery_note_id" value="<?php echo $data->id;?>">
        								...
        								<div class="form-group">
        								    ...
        								    <div class="col-md-5">
        								        <input type="text" name="note" class="form-control" placeholder="Note" value="<?php echo $data->note;?>">
        								    </div>
        								</div>
        								...
        								<div class="form-group">
        								    ...
        								    <div class="col-md-5">
        								        ...
        								        <button class="btn btn-danger">
        								            <a class="js-link" href="<?php echo base_url();?>admin/deliveryNote/delete/<?php echo $data->id;?>">Delete</a>
        								        </button>
        								    </div>        								    
                                        </div>
    								</fieldset>			
